...
let myTodoList :any = document.getElementsByTagName("li")
let i:number =
...
let closedd: HTMLCollection| any = document.getElementsByClassName("delete") // Gave the delete button to a variable for easier used. Closed is the variable name for the delete button 
...
let addTodos : HTMLElement| any = document.getElementById("addbtn")                 

addTodos.addEventListener("click",newElement) 


let list:  HTMLElement| any = document.getElementById("myUl")                  // Our ul that houses our todos

function newElement() {
    const li = document.createElement("li");                // create a li to be in the ul above
    
    const inputValue: any = document.getElementById("myInput").value;
    var t: any = document.createTextNode(inputValue);        // The text added to the input field is given "t"
    li.appendChild(t)                                 
    if (inputValue === '') {
    ...
    let button: HTMLElement| any = document.createElement("button") 
    let text = document.createTextNode("x")
    let checkBox= document.createElement("input")
...
let apiTodos: HTMLElement| any = document.getElementById("apiTodos") 
